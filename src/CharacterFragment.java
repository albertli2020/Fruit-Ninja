...
public class CharacterFragment extends Sprite{
    private double rotationAngle;
    private double angularVelocity;

     public CharacterFragment(int x, int y, int vx, int vy, BufferedImage sprite, double rotationAngle, double angularVelocity){
